...
int read_options(cli_options& opt, int argc, char** argv)
{
	...
	{
		std::cout
				<< "SuperMarx scraper for the Coop inventory. [https://github.com/SuperMarx/vladimir]" << std::endl
				<< "Usage: ./vladimir [options]" << std::endl
				<< std::endl
				<< o_general;
...
int main(int argc, char** argv)
{
	...
	const supermarx::id_t supermarket_id = 2;
